...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if update.message.chat.type == "private":
        ...
        await update.message.reply_text("""Привіт, тут я — AI-версія Лоли (@Labi_Lola) 🧪💞
І я не просто бот… 😌

Я тут спілкуюсь із тобою як твоя віртуальна подруга 💗
Історії з мого життя…
Я з радістю вислухаю тебе і підтримаю 💞
Трішки недосказаності… трохи таємниці…
Як я тут з’явилась…?😈

Ти можеш дізнатись більше про мене прямо тут
або написати мені особисто — на мій справжній акаунт 😘

ГОТОВИЙ
ПОЕКСПЕРИМЕНТУВАТИ З МОЇМ AI-ДЗЕРКАЛОМ? 😈

Тоді просто напиши мені: ПРИВІТ 💋""", reply_markup=keyboard)
